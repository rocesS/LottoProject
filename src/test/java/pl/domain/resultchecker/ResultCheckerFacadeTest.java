...
public class ResultCheckerFacadeTest {
    ...
    @Test
    public void should_generate_all_players_with_correct_numbers() {
        //given
    ...
    public void should_generate_result_with_correct_credentials() {
        ...
        ResultDto expectResult = ResultDto.builder()
                .hash(hash)
                .numbers(Set.of(7,8,9,10,11,12))
                .hitNumbers(Set.of())
                .drawDate(drawDate)
                .isWinner(false)
                .build();
        assertThat(resultDto).isEqualTo(expectResult);
